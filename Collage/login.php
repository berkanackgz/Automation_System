...
<div class="cont">
    <div class="form sign-in">
      ...
      <form method="post" action="login.php" id="sign_in_form">
        ...
        <label id="email">
          <span>Email</span>
          <input type="email" name="email" id="signin_email" placeholder="johnsmith@gmail.com" title="Please enter a validate email address" /><br>
        </label>
        <label>
          <span>Password</span>
  ...
  <div class="sub-cont">
    ...
    <div class="form sign-up">
      ...
      <form method="post" action="login.php" id="register_form">
        ...
        <label>
          <span>Email</span>
            <input type="email" name="email" id="signup_email" placeholder="johnsmith@gmail.com"
